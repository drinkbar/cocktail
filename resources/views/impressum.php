<main>
	<div class="row">
		...
		<div class="large-12 columns">
			...
			<ul id="impressum">
				<li>Jessica Sauter</li>
				<li>Arno-Nitzsche-Stra&szlig;e 20</li>
				<li>04277 Leipzig</li>
				<li>Telefon: 01734489483</li>
				<li>E-Mail: jessica-sauter@gmx.de</li>
			...
			<h3>Urheberrecht</h3>
			<p>Die durch die Seitenbetreiber erstellten bzw. verwendeten Inhalte
				und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht.
				Die Vervielf&auml;ltigung, Bearbeitung, Verbreitung und jede Art der
				Verwertung au&szlig;erhalb der Grenzen des Urheberrechtes
				bed&uuml;rfen der Zustimmung des jeweiligen Autors bzw. Erstellers.
				Downloads und Kopien dieser Seite sind nur f&uuml;r den privaten,
			...
			<p>Die Nutzung unserer Webseite ist in der Regel ohne Angabe
				...
				ausdr&uuml;ckliche Zustimmung nicht an Dritte weitergegeben. Wir
				...
				Dritte ist nicht m&ouml;glich. Der Nutzung von im Rahmen der
				Impressumspflicht ver&ouml;ffentlichten Kontaktdaten durch Dritte zur
				&uuml;bersendung von nicht ausdr&uuml;cklich angeforderter Werbung
				und Informationsmaterialien wird hiermit ausdr&uuml;cklich
			...
			<p>Unser Angebot enth&auml;lt Links zu externen Webseiten Dritter, auf
				...
				&uuml;bernehmen. F&uuml;r die Inhalte der verlinkten Seiten ist stets
